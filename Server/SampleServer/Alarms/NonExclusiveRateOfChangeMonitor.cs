...
{
    /// <summary>
    /// A monitored variable with an <see cref="NonExclusiveRateOfChangeAlarmState"/> attached.
    /// </summary>
    class NonExclusiveRateOfChangeMonitor : LimitAlarmMonitor<NonExclusiveRateOfChangeAlarmState>
    {
        #region Constructors
        ...
        protected override void ProcessVariableChanged(ISystemContext context, object value)
        {
            try
            {
                         ...
                         && newValue >= m_alarm.HighHighLimit.Value)
                {
                    ...
                    m_alarm.Message.Value = new LocalizedText("en-US", String.Format("Alarm ActiveState = {0}, State HighHigh & High = {1} & {2}", m_alarm.ActiveState.Value, m_alarm.HighHighState?.Value.Text, m_alarm.HighState?.Value));
