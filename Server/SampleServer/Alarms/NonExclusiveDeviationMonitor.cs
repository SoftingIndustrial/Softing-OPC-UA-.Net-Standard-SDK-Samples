...
{
    /// <summary>
    /// A monitored variable with an <see cref="NonExclusiveDeviationAlarmState"/> attached.
    /// </summary>
    class NonExclusiveDeviationMonitor : LimitAlarmMonitor<NonExclusiveDeviationAlarmState>
    {
        #region Constructors
        ...
        protected override void ProcessVariableChanged(ISystemContext context, object value)
        {
            ...
            {
                Utils.Trace(exception, "Alarms.NonExclusiveDeviationMonitor.ProcessVariableChanged: Unexpected error processing value changed notification.");
            }
        }
        #endregion
