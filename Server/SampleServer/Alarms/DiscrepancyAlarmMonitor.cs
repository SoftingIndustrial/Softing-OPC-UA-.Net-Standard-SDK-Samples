        ...
        protected override void ProcessVariableChanged(ISystemContext context, object value)
        {
            try
            {
                ...
                if (updateRequired)
                {
                    ...
                    string message = String.Format("Alarm ActiveState = {0}, ExpectedTime = {1}, Tolerance = {2}, AckedState = {3}, ConfirmedState = {4}",
                       m_alarm.ActiveState.Value,
                       m_alarm.ExpectedTime.Value,
                       m_alarm.Tolerance.Value,
