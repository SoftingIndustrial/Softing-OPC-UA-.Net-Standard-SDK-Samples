...
namespace TestServer.HistoricalEvents
{
	...
	public partial class WellTestReportState : BaseEventState
	{
		...
		{
			return NodeId.Create(ObjectTypes.WellTestReportType, Namespaces.HistoricalEvents, namespaceUris);
		}
	...
	public partial class FluidLevelTestReportState : WellTestReportState
	{
		...
		protected override NodeId GetDefaultTypeDefinitionId(NamespaceTable namespaceUris)
		{
			return NodeId.Create(ObjectTypes.FluidLevelTestReportType, Namespaces.HistoricalEvents, namespaceUris);
		}
	...
	public partial class InjectionTestReportState : WellTestReportState
	{
		...
		protected override NodeId GetDefaultTypeDefinitionId(NamespaceTable namespaceUris)
		{
			return NodeId.Create(ObjectTypes.InjectionTestReportType, Namespaces.HistoricalEvents, namespaceUris);
		}
			...
			BaseInstanceState replacement)
		{
			...
			switch(browseName.Name)
			{
				...
				case BrowseNames.InjectedFluid:
					{
						if (createOrReplace)
						{
	...
	public partial class WellState : BaseObjectState
	{
		...
		protected override NodeId GetDefaultTypeDefinitionId(NamespaceTable namespaceUris)
		{
			return NodeId.Create(ObjectTypes.WellType, Namespaces.HistoricalEvents, namespaceUris);
		}
