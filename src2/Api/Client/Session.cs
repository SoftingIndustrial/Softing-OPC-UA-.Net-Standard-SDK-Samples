...
namespace Opc.Ua.Toolkit.Client
{
    ...
    public partial class Session : BaseStateManagement, IDisposable
    {
        ...
        /// </summary>
        /// <param name="browsePaths">The list of <see cref="SimpleBrowsePath"/> requests to be translated.</param>
        ...
        public virtual IList<SimpoleBrowsePathResult> TranslateBrowsePathsToNodeIds(List<SimpleBrowsePath> browsePaths)
        {
            if (browsePaths == null)
            {
            ...
            try
            {
                ...
                foreach (SimpleBrowsePath browsePath in browsePaths)
                {
                    BrowsePath pathToTranslate = new BrowsePath();
                ...
                List<SimpoleBrowsePathResult> translateResults = new List<SimpoleBrowsePathResult>();

                // create the list of results.
                foreach (BrowsePathResult result in results)
                {
                    SimpoleBrowsePathResult translateResult = new SimpoleBrowsePathResult();
