...
namespace SampleClient.StateMachine
{
    ...
    public enum State
    {
        ...
        MonitoredTransferDurableEventsAlarms,
        MonitoredEvents,
    ...
    public enum Command
    {
        ...
        StartMonitoredEventsAlarmsTransferDurable,
        EndMonitoredTransferEventsAlarms,

        StartMonitoredItems,
        EndMonitoredItems,

        StartDurableSubscriptions,
        StartTransferSubscriptions,
        EndTransferSubscriptions,
        EndDurableSubscriptions,
        ...
        StartMonitoredItem,
        CreateMonitoredItem,
        CreateDurableMonitoredItem,
        CreateDurableSubscriptions,
        CreateDurableMonitoredItemAndEvents,
        DeleteMonitoredItem,
        DeleteDurableMonitoredItem,
        EndMonitoredItem,
        EndDurableMonitoredItem,
        TransferDurableSubscriptionsCurrentSession,
        TransferDurableSubscriptionsNewSession,
        DurableCustomSessionModelSaveLoad,
        DurableCustomSubscriptionModelSaveLoad,
        DurableCustomMonitoredItemModelSaveLoad,
        TransferSubscriptions,
